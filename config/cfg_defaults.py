...
# Interpolation method for scan interpolation. Default is False
_C.DATA.INTERPOLATION = False
...
# Training slcie level batch size
_C.TRAIN.SLICE_LEVEL_BATCH_SIZE = 200
# Training scan level batch size
_C.TRAIN.SCAN_LEVEL_BATCH_SIZE = 4
# Voting for prediction. Default is majority voting
_C.TRAIN.VOTING = "majority"
